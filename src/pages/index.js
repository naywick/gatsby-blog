  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <p>
          I also write and was shortlisted for the <a href="https://bricklanebookshop.org/2021-short-story-prize/">Brick Lane Bookshop Short Story Prize</a>. I am currently working on a novel about two women from my native Sri Lanka.
        </p>
        <Link to="/blog/">
